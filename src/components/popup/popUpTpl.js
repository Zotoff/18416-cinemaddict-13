...
export const popUpView = (film) => {
  const {name, poster, ageRating, originalName, rating, director, writers, actors, releaseDate, duration, country, genres, description, comments} = film;
